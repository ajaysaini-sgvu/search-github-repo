...
interface ApiHelper {
    fun searchRepo(repositoryName: String): Observable<SearchRepositoryResponse>?
    fun fetchSubscribers(owner: String?, repo: String?): Observable<List<SubscriberResponse>>?
}